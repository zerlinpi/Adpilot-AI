...
/**
 * MyBatis-Plus mapper for the {@code report_sync_errors} table.
 */
@Mapper
public interface ReportSyncErrorMapper extends BaseMapper<ReportSyncErrorEntity> {
     ...
     */
    @Delete("DELETE FROM report_sync_errors WHERE created_at < #{cutoff} LIMIT #{batchSize}")
